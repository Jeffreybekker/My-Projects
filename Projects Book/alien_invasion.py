...
class AlienInvasion:
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            self.stats.ships_left -= 1 # Decrement ships_left, and update scoreboard.
            self.sb.prep_ships()

            self.aliens.empty() # Get rid of any remaining aliens.
            self.bullets.empty() # Get rid of any remaining bullets.
    ...
    def _check_fleet_edges(self):
        """Respond appropriate if any aliens have reached an edge."""
        for alien in self.aliens.sprites():
    ...
    def _update_screen(self):
        ...
        if not self.stats.game_active:  # Draw the play button if the game is active.
